...
| 6 | Marca de venta anulada: fecha, **quién autorizó la anulación** y motivo | Sí | Sí | Sí |
...
**Lo que se oculta es una lista CERRADA de dos datos**: el 12 y el 15. Todo lo
demás sale en las dos copias. Eso incluye cualquier dato que se agregue al
...
| CA-3 | La copia del cliente difiere de la de la tienda **exactamente** en esto: su encabezado es «COPIA DEL CLIENTE», no lleva el renglón «Autorizado por: …» y no lleva el renglón «Boleta …». **Ningún otro renglón cambia ni cambia de orden.** | Vitest, comparación renglón por renglón en la misma grilla, y app real con los bytes |
...
| CA-5 | La copia del cliente **sí** lleva el cajero, las líneas, el descuento con su valor y su rebaja, la aclaración, el TOTAL, la forma de pago, la reimpresión y la marca de anulada completa. | Vitest y app real |
| CA-6 | Una venta en efectivo sin descuento autorizado: las dos copias **difieren solo en el encabezado**. | Vitest |
...
## 9. Preguntas abiertas para Julio
